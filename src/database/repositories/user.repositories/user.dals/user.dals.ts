...
class UserDALs {
    async createUser({categoryId, personId, typeGrantId, loginUserId, dailyMeals}: IUserCreate) {
    ...
    async updateUser({id, categoryId, name, typeGrantId, dailyMeals}: IUserUpdate) {
